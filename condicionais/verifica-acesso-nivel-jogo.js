/*
  Você está criando um sistema para um jogo, onde o personagem tem que passar por duas condições
  ...
  Crie um programa que, dado os pontos e as vidas restantes, verifique se o personagem pode ou não
